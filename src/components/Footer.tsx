      ...
      <div className="container">
        <div className="footer-content">
          <div className="footer-section">
            <h4>Anshu Raturi</h4>
            <p>Full Stack Developer | Cybersecurity Enthusiast | Web3 Explorer</p>
          </div>
          <div className="footer-section">
            <h4>Quick Links</h4>
            <ul>
          ...
          <div className="footer-section">
            ...
            <div className="social-links">
              <a href="https://github.com/Anshuraturi" className="social-link" target="_blank" rel="noopener noreferrer" title="GitHub">
              ...
              <a href="https://www.linkedin.com/in/anshu-raturi-406310322/" className="social-link" target="_blank" rel="noopener noreferrer" title="LinkedIn">
                <svg viewBox="0 0 24 24" fill="currentColor" className="social-icon">
